...
| `Session.extract(content_selector=None, remove_images=False, language=None, debug=False)` | Runs pinned Defuddle extraction against the live DOM and returns content, Markdown, and metadata. |
