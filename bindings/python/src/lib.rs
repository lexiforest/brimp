...
impl PySession {
    #[new]
    #[pyo3(signature = (persona_json = None, ca_bundle = None, enable_worker = false, enable_streaming_networking = false, enable_canvas = false, storage_path = None, storage_quota_bytes = None))]
