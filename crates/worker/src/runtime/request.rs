...
use crate::web_apis::BrowsingContext;
use std::sync::Arc;
...
pub(crate) struct RedirectHop {
    ...
    pub headers: crate::network::HeaderList,
    pub url: String,
}
...
pub(crate) fn fetch_callback(
    ...
    request: ResourceRequest,
    callback: crate::network::ResourceCallback,
) -> Result<(), NetworkError> {
...
struct RedirectTask {
    ...
    request: ResourceRequest,
    redirects: usize,
    callback: Arc<std::sync::Mutex<Option<crate::network::ResourceCallback>>>,
}
impl RedirectTask {
...
fn finish_callback(
    callback: &std::sync::Mutex<Option<crate::network::ResourceCallback>>,
...
mod tests {
    use super::*;
    use crate::network::{HeaderList, ResourceLoader};
