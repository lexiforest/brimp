//! Decode and validate canvas arguments from JavaScript native calls.

use crate::jsc::{NativeCall, NativeError};
use crate::web_apis::canvas::{
    CanvasDrawEffects, CanvasFilterInput, CanvasFilterOperation, CanvasLightSource,
    CanvasPaintStyle, CanvasShadowStyle, CanvasStrokeStyle,
};

use super::required_string;

pub(super) fn required_canvas_paint_style(
    call: &NativeCall<'_>,
    index: usize,
...
pub(super) fn required_canvas_stroke_style(
    call: &NativeCall<'_>,
    index: usize,
...
pub(super) fn required_canvas_draw_effects(
    call: &NativeCall<'_>,
    index: usize,
