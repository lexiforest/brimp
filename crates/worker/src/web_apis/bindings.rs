...
use crate::web_apis::{
    ...
    canvas::{CanvasColorSpace, CanvasColorType, CanvasStore},
};
...
const CLASS_DEFINITIONS: &str = concat!(
    include_str!("../../js/web_apis/runtime/bootstrap.js"),
    include_str!("../../js/web_apis/runtime/events_messaging.js"),
    include_str!("../../js/web_apis/runtime/dom_core.js"),
    include_str!("../../js/web_apis/runtime/cssom.js"),
    include_str!("../../js/web_apis/runtime/document_collections.js"),
    include_str!("../../js/web_apis/runtime/elements.js"),
    include_str!("../../js/web_apis/runtime/html_elements.js"),
    include_str!("../../js/web_apis/runtime/window_location.js"),
    include_str!("../../js/web_apis/runtime/navigator_services.js"),
    include_str!("../../js/web_apis/runtime/url_encoding_files.js"),
    include_str!("../../js/web_apis/runtime/storage_fetch.js"),
    include_str!("../../js/web_apis/runtime/css_style.js"),
    include_str!("../../js/web_apis/runtime/observers.js"),
    include_str!("../../js/web_apis/runtime/input.js"),
    include_str!("../../js/web_apis/runtime/install.js"),
);
...
impl WebFeatureFlags {
    pub fn json(self) -> String {
        format!("{{\"persistentStorage\":{}}}", self.persistent_storage)
    }
}
...
impl BrowsingContext {
    ...
    pub fn store_resource_cors(
        ...
        requested_url: &str,
        effective_url: &str,
        headers: &crate::network::HeaderList,
        credentials_sent: bool,
    ) {
    ...
    pub fn apply_request_identity(&self, headers: &mut crate::network::HeaderList) {
...
impl BindingRuntime {
    pub fn canvas_rasters(&self) -> Result<Vec<crate::web_apis::canvas::CanvasRaster>, String> {
    ...
    pub fn install(
        ...
        runtime.eval(include_str!("../../js/web_apis/worker_system.js"))?;
        *state.worker_delivery.borrow_mut() = Some(
        ...
        if features.persistent_storage {
            ...
            runtime.eval(include_str!("../../js/web_apis/persistent_storage.js"))?;
        ...
        runtime.eval(include_str!("../../js/web_apis/streaming_networking.js"))?;
        ...
        *state.fetch_stream_delivery.borrow_mut() = Some(
        ...
        runtime.eval(include_str!("../../js/web_apis/canvas.js"))?;
        ...
        runtime.eval(if cross_origin_isolated {
            include_str!("../../js/web_apis/cross_origin_isolated.js")
        } else {
            include_str!("../../js/web_apis/cross_origin_unisolated.js")
        })?;
    ...
    pub fn sync_window_named_properties(&self, runtime: &JsRuntime) -> Result<(), JsException> {
        ...
        let script = include_str!("../../js/web_apis/sync_window_named_properties.js")
...
fn dispatch(state: &BindingState, call: &NativeCall<'_>) -> Result<NativeValue, NativeError> {
    ...
    match operation.as_str() {
        ...
        operation if operation.starts_with("canvas") => {
