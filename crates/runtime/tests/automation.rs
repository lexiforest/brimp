...
use brimp_runtime::{AutomationBrowser, AutomationError, PageOptions, RemoteArgument, TouchPoint};
...
fn concurrent_pages_pin_distinct_proxies_and_share_context_cookies() {
    ...
    let browser = AutomationBrowser::with_persona_and_network_config(
        brimp_persona::PersonaConfig::default(),
        brimp_network::CurlConfig::default(),
    )
    .unwrap();
