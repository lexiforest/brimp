...
Extraction types and the pinned Defuddle bundle are shared by the in-process
language bindings and worker-backed CLI. Verify the bundle and licenses with
