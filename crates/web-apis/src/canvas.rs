...
const WENQUANYI_FONT: &[u8] = include_bytes!("../../dom/assets/fonts/wqy-microhei.ttc");
const NOTO_EMOJI_FONT: &[u8] = include_bytes!("../../dom/assets/fonts/noto-color-emoji.ttf");
